...
// -------------------Variables----------------------
const char* ssid     = "ssid"; //login du wifi
const char* password = "password"; //mdp du wifi
const char* serverName = "server"; //hosting site a dave
//const char* serverName1 = ""; //hosting site a dave
